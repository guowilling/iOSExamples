...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL shouldShow = [NewFeaturesViewController shouldShowNewFeature];
    shouldShow = YES; // set YES for test
    if (shouldShow) {
        NSArray *imageNames = @[@"newfeature1.jpg", @"newfeature2.jpg", @"newfeature3.jpg", @"newfeature4.jpg"];
        NewFeaturesViewController *newFeaturesVC = [NewFeaturesViewController newFeatureWithImageNames:imageNames switchRootVCBtnImageName:@"start_huanshi_AR_normal"  rootViewController:[ViewController new]];
