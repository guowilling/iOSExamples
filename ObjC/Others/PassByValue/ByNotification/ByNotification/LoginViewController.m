...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(update:) name:@"EnrollSuccess" object:nil];
}
...
- (void)update:(NSNotification *)notification {
    ...
    _passWordText.text = userInfo[@"password"];
}
...
- (void)buttonAction:(UIButton *)button {
    ...
    if (button == _loginBtn) {
        ...
        loginedVC.userName = _userNameText.text;
        loginedVC.passWord = _passWordText.text;
