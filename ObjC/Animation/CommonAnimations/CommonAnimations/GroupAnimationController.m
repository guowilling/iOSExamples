...
- (NSArray *)operateTitleArray {
    ...
    return [NSArray arrayWithObjects:@"同时执行", @"顺序执行", nil];
}
...
- (void)groupAnimation2 {
    ...
    CFTimeInterval anima1BeginTime = currentTime;
    anima1.beginTime = anima1BeginTime;
    ...
    anima2.fromValue = [NSNumber numberWithFloat:0.8f];
    anima2.toValue = [NSNumber numberWithFloat:2.0f];
    CFTimeInterval anima2BeginTime = anima1BeginTime + 1.0;
    anima2.beginTime = anima2BeginTime;
    ...
    CABasicAnimation *anima3 = [CABasicAnimation animationWithKeyPath:@"transform.rotation"];
    anima3.toValue = [NSNumber numberWithFloat:M_PI*4];
    CFTimeInterval anima3BeginTime = anima2BeginTime + 1.0;
    anima3.beginTime = anima3BeginTime;
